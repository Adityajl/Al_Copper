...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _submitOTP() async {
    try {
      ...
      await _auth.signInWithCredential(credential);
      // Navigate based on user role or show success message
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_isPhoneRegister && _isOTPSent)
    Column(
    children: [
    SizedBox(height: 20),
    TextField(
    ...
    SizedBox(height: 20),
    ElevatedButton(
    onPressed: _isPhoneRegister && _isOTPSent ? _submitOTP : _register,
    ...
    child: Text(
    _isPhoneRegister ? 'Submit OTP' : 'Register',
    style: TextStyle(color: Colors.white),
    ),
    ),
    SizedBox(height: 20),
    ...
    // Add this part for the "Already a user?" section
    SizedBox(height: 20),
