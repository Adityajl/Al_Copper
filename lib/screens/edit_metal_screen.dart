...
class EditMetalScreen extends StatefulWidget {
  final String metalId;
  final Map<String, dynamic> initialData;

  EditMetalScreen({required this.metalId, required this.initialData});

  @override
  _EditMetalScreenState createState() => _EditMetalScreenState();
}

class _EditMetalScreenState extends State<EditMetalScreen> {
  ...
  void initState() {
    ...
    _changeController.text = widget.initialData['change'];
    _colorController.text = widget.initialData['color'];
    _types = List<Map<String, dynamic>>.from(widget.initialData['types'] ?? []);
  }
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      _firestore.collection('metals').doc(widget.metalId).update({
